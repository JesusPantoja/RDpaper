...
\begin{figure}
	...
	\caption{Standard deviation of somite size as function of coefficient of variation. In this plot we can see how increasing the coefficient of variation ($C_V$) affect the regularity of somite size.}
	\label{Fig06_2}
\end{figure}
