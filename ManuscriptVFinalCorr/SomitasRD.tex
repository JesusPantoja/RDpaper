...
\begin{figure}
	...
	\caption{Standard deviation of somite size for different intervals of variation in the initial conditions (IC). The IC were randomly selected from a uniform distribution from the different intervals shown in the X-axis. This results show that, variations in the initial conditions do not affect the somite size.}
	\label{Fig06_1}
\end{figure}
