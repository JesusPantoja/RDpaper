...
\begin{figure}
	...
	\caption{Somite size as function of wavefront velocity (v). A) Somites size considering diffusion in the activator with $d_a = 5\times10^{-5}$. B) Somites size without diffusion in the activator ($d_a = 0$). Here we can appreciate that without diffusion in the activator the model is not affected by the wavefront.}
	\label{Fig04_1}
\end{figure}
...
\begin{figure}
	...
	\caption{Standard deviation of somite size for different intervals of variation in the initial conditions (IC). The IC were randomly selected from a uniform distribution in the different intervals shown in the X-axis. This results show the robustness of our model as variations in the initial conditions do not affect the somite size.}
	\label{Fig06_1}
\end{figure}
...
\begin{figure}
	...
	\caption{Standard deviation of somite size as function of coefficient of variation ($C_v$). Here we can see show how higher $C_v$ increasing the irregularity of somite size.}
	\label{Fig06_2}
\end{figure}
